...
function KpiCard({ label, value, sub, delta, deltaType }: {
  ...
  return (
    <Card decoration="top" decorationColor="cyan" style={{ fontFamily: 'Plus Jakarta Sans' }}>
      ...
      <Grid numItemsSm={1} numItemsLg={2} className="gap-6">
        {terrData.length > 0 && (
          <Card>
            ...
            <BarChart data={terrData} index="name" categories={['Habitantes']} colors={['cyan']} valueFormatter={fmt} showLegend={false} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} />
          </Card>
        )}
        {areasData.length > 0 && (
          <Card>
            <SectionTitle title="Indicadores por área temática" />
            <BarChart data={areasData} index="Área" categories={['Indicadores']} colors={['blue']} showLegend={false} showAnimation layout="vertical" style={{ fontFamily: 'Plus Jakarta Sans' }} />
          </Card>
        )}
      </Grid>
    ...
    <div className="flex flex-col gap-8">
      ...
      <Grid numItemsSm={1} numItemsLg={2} className="gap-6">
        {eixoData.length > 0 && (
          <Card>
            ...
            <BarChart data={eixoData} index="Eixo" categories={['Programas']} colors={['cyan']} showLegend={false} showAnimation layout="vertical" style={{ fontFamily: 'Plus Jakarta Sans' }} />
          </Card>
        )}
        {statusData.length > 0 && (
          <Card>
            <SectionTitle title="Distribuição por status" />
            <DonutChart data={statusData} category="Programas" index="name" colors={COLORS} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} valueFormatter={(v) => `${v} programa${v !== 1 ? 's' : ''}`} />
            <Legend categories={statusData.map((d: any) => d.name)} colors={COLORS} className="mt-4" style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.8rem' }} />
          </Card>
        )}
      </Grid>
      ...
      {terrData.length > 0 && (
        <Card>
          ...
          <BarChart data={terrData} index="Território" categories={['Programas']} colors={['blue']} showLegend={false} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} />
        </Card>
      )}
    ...
    <div className="flex flex-col gap-8">
      ...
      <Grid numItemsSm={1} numItemsLg={2} className="gap-6">
        {tipoData.length > 0 && (
          <Card>
            ...
            <BarChart data={tipoData} index="Tipo" categories={['Projetos']} colors={['indigo']} showLegend={false} showAnimation layout="vertical" style={{ fontFamily: 'Plus Jakarta Sans' }} />
          </Card>
        )}
        {statusData.length > 0 && (
          <Card>
            <SectionTitle title="Distribuição por status" />
            <DonutChart data={statusData} category="Projetos" index="name" colors={COLORS} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} valueFormatter={(v) => `${v} projeto${v !== 1 ? 's' : ''}`} />
            <Legend categories={statusData.map((d: any) => d.name)} colors={COLORS} className="mt-4" style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.8rem' }} />
          </Card>
        )}
      </Grid>
      ...
      {terrData.length > 0 && (
        <Card>
          ...
          <BarChart data={terrData} index="Território" categories={['Projetos']} colors={['sky']} showLegend={false} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} />
        </Card>
      )}
      ...
      <Grid numItemsSm={1} numItemsLg={2} className="gap-6">
        {tipoData.length > 0 && (
          <Card>
            ...
            <DonutChart data={tipoData} category="Unidades" index="Tipo" colors={COLORS} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} valueFormatter={(v) => `${v} unidade${v !== 1 ? 's' : ''}`} />
            <Legend categories={tipoData.map((d: any) => d.Tipo)} colors={COLORS} className="mt-4" style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.8rem' }} />
          </Card>
        )}
        {terrData.length > 0 && (
          <Card>
            <SectionTitle title="Equipamentos por território" />
            <BarChart data={terrData} index="Território" categories={['Unidades']} colors={['teal']} showLegend={false} showAnimation style={{ fontFamily: 'Plus Jakarta Sans' }} />
          </Card>
        )}
      </Grid>
    ...
    <div style={{ background: BG, minHeight: '60vh' }}>
      <div className="max-w-7xl mx-auto px-6 py-10">
        {vazio ? (
          ...
          <TabGroup>
            <TabList className="mb-8" style={{ fontFamily: 'Plus Jakarta Sans' }}>
              {[
