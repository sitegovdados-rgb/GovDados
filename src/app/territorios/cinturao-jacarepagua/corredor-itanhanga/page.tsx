...
const MAPAS = [
  {
    ...
    url: 'https://drive.google.com/uc?export=view&id=180RS5Uh51rAZJjfUW9t7NvEt9GFUztuT',
  },
  {
    titulo: 'Mapa de Mobilidade',
    descricao: 'Projetos do PCI, ciclovias existentes e projetadas, transporte BRT, metrô e hidroviário.',
    url: 'https://drive.google.com/uc?export=view&id=1n1sNKwTxAZUM6Xa7ovPAy9cE4ieGsREg',
  },
  {
    ...
    url: 'https://drive.google.com/uc?export=view&id=1MNj7Wl55DD_qzeRxKSgsQbo6UuH-whtG',
  },
]
      ...
      <section style={{ background: 'linear-gradient(135deg, var(--pci-navy) 0%, #1e3a8a 100%)', color: 'white', borderBottom: '3px solid var(--pci-cyan)' }}>
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <p style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.95rem', color: 'rgba(255,255,255,0.65)', maxWidth: 580, lineHeight: 1.7, marginBottom: 16 }}>
            Sub-território com 9 comunidades em área de transição entre a Barra da Tijuca e Jacarepaguá, marcado por rico histórico cultural e pela tragédia da Muzema em 2019.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-14">
        ...
        <section>
          ...
          <DiagnosticoIA
            ...
            equipamentos={equipCI.slice(0, 8)}
          />
        </section>
