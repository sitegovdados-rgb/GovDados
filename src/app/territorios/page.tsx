    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-10">
        ...
        <p style={{ fontFamily: 'Plus Jakarta Sans', color: 'var(--pci-dim)', maxWidth: 600, lineHeight: 1.7 }}>
          O Programa Cidade Integrada atua em territórios historicamente conflagrados do Rio de Janeiro. Cada território é composto por sub-territórios e favelas com características próprias.
        </p>
      </div>
