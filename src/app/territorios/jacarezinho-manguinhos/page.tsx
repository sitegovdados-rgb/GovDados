...
export default async function ManguinhosPage() {
  ...
  try {
    territorio   = await getTerritorio('manguinhos-jacarezinho')
    indicadores  = await getIndicadoresPorSlug('manguinhos-jacarezinho')
      ...
      <section style={{ background: 'linear-gradient(135deg, var(--pci-navy) 0%, #1e3a8a 100%)', color: 'white', borderBottom: '3px solid var(--pci-cyan)' }}>
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <p style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: 600, lineHeight: 1.7, marginBottom: 20 }}>
            {territorio?.descricao || 'Territórios da Zona Norte do Rio de Janeiro, ao longo das linhas férreas e da Avenida Brasil, com forte histórico de vulnerabilidade social e intervenção pública.'}
          </p>
