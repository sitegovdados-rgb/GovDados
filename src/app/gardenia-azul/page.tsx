...
const MAPAS = [
  {
    ...
    url: 'https://drive.google.com/uc?export=view&id=1PxIQEFyrWKdM927q_71zQMwLVWlWJetn',
  },
  {
    titulo: 'Mapa de Mobilidade Urbana',
    descricao: 'Linhas de ônibus, BRT, rede cicloviária e transporte hidroviário na região.',
    url: 'https://drive.google.com/uc?export=view&id=16nQWnWmcVMtfi9Iv3_ueChCffNSVLWh6',
  },
  {
    ...
    url: 'https://drive.google.com/uc?export=view&id=1xAnMnqShITrh3-jwgzw9qDJY4QUFGmDm',
  },
  {
    titulo: 'Mapa de Equipamentos Públicos',
    descricao: 'Unidades educacionais, de saúde, praças, quadras e terrenos subutilizados.',
    url: 'https://drive.google.com/uc?export=view&id=1UXH-nw38bUT2N_ezGIMlBxJ0p6VNFNWP',
  },
]
    ...
    <div>
      ...
      <section style={{ background: 'linear-gradient(135deg, var(--pci-navy) 0%, #1e3a8a 100%)', color: 'white', borderBottom: '3px solid var(--pci-cyan)' }}>
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <p style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.95rem', color: 'rgba(255,255,255,0.65)', maxWidth: 580, lineHeight: 1.7, marginBottom: 16 }}>
            Sub-território com 5 comunidades na Zona Sudoeste do Rio de Janeiro, inserido na Baixada de Jacarepaguá — XVI Região Administrativa.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-14">
        ...
        <section>
          ...
          <DiagnosticoIA
            subTerritorio={SUB}
            indicadores={indGardenia}
            programas={programas.slice(0, 8)}
            equipamentos={equip.slice(0, 8)}
          />
        </section>
