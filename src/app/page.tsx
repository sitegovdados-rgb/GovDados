      ...
      <section style={{ background: 'linear-gradient(135deg, var(--pci-navy) 0%, #1e3a8a 100%)', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-10">
          ...
          <div className="max-w-2xl mb-10">
            <span className="pci-tag-navy mb-4">Governo do Estado do Rio de Janeiro · ADPF 635 · STF</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
            {territoriosList.map((t: any) => (
              <div key={t.slug} style={{
                ...
                <p style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.78rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.6, marginBottom: 16 }}>
                  {t.descricao}
                </p>
                {t.status === 'ativo' ? (
