        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
              ...
              <Link href="/painel" style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 600, fontSize: '0.875rem', padding: '12px 24px', borderRadius: 8, background: 'rgba(255,255,255,0.1)', color: 'white', border: '2px solid rgba(255,255,255,0.25)', display: 'inline-block' }}>
                Ver Painel de Dados
              </Link>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4">
              {[
                ...
                <div key={i} style={{ padding: '20px 24px', borderRight: i < 3 ? '1px solid rgba(255,255,255,0.08)' : 'none' }}>
