  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      <div style={{ maxWidth: 560, margin: '0 auto', textAlign: 'center' }}>
        ...
        <h1 className="pci-title" style={{ fontSize: '2rem', marginTop: 16, marginBottom: 12 }}>Programas Sociais</h1>
        <p style={{ fontFamily: 'Plus Jakarta Sans', fontSize: '0.95rem', color: 'var(--pci-dim)', lineHeight: 1.7, marginBottom: 32 }}>
          A seção de Programas Sociais está em desenvolvimento. Em breve disponibilizaremos informações completas sobre as ações e serviços sociais do Programa Cidade Integrada nos territórios do Rio de Janeiro.
        </p>
